...
struct Varyings
{
    ...
    float2 uv           : TEXCOORD1;
    float2 uvMetallic                 : TEXCOORD10;
    float2 uvNormal                 : TEXCOORD11;
...
Varyings DepthNormalsVertex(Attributes input)
{
    ...
    output.uvMetallic = TRANSFORM_TEX(input.texcoord, _MetallicGlossMap);
    output.uvNormal   = TRANSFORM_TEX(input.texcoord, _BumpMap);
