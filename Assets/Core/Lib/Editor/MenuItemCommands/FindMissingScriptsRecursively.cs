...
{
    [MenuItem("Auto/Remove Missing Scripts In Project")]
    private static void FindAndRemoveMissingInProject()
    {
        FindAndRemoveMissing(
            AssetDatabase
    ...
    [MenuItem("Auto/Remove Missing Scripts In Selected")]
    private static void FindAndRemoveMissingInSelected()
    {
        ...
        FindAndRemoveMissing(deeperSelection);
    }

    private static void FindAndRemoveMissing(IEnumerable<GameObject> deeperSelection)
    {
